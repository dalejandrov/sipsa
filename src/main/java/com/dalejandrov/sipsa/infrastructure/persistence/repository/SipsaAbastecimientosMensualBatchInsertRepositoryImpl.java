 ...
 * {@link SipsaMayoristasMensualBatchInsertRepositoryImpl}'s TECH-060 technique.
 * <p>
 ...
 * fecha_mes_ini) DO NOTHING} (backed by the existing {@code ux_abas_fallback} constraint)
...
public class SipsaAbastecimientosMensualBatchInsertRepositoryImpl implements SipsaAbastecimientosMensualBatchInsertRepository {
    ...
    @Override
    public int[] insertIgnoringConflicts(List<SipsaAbastecimientosMensual> rows) {
